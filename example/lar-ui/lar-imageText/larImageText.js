...
使用方法:
   HTML - 找到需要放置内容的div或其他标签，并拿到该容器的标识名（例：showImageTextTwo）
   //文字图片实例
	var judicialpostUrl = baseUrl + '/sword/search/ChannelService/getResultDataByIds';
	var judicialparm={'ids':'Macao_ZTlfh'};
	$('.showImageTextTwo').larImageText({
    	postUrl: judicialpostUrl,
    	postParm: judicialparm,
    	parmName: 'Macao_ZTlfh',
    	dataWord: dataWords,
    	dataimgPath: 'path',
    	dataimgUrl: 'url'
	})
