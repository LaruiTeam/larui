...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).ready(function () {
	...
	__WEBPACK_IMPORTED_MODULE_0_jquery___default.a.get("getFigureHead.json", function (data) {
		__WEBPACK_IMPORTED_MODULE_0_jquery___default()(".art_classfications1").gallery({
