		...
		Gallery.fn = Gallery.prototype = {
			...
			maskEffect: function () {
				...
				$.each(this.options.dataList, function (i, e) {
					...
					picHtml += "<div class='galleryPic " + _this.options.pageSizeClass + "'><a target= _blank href='" + e.hyperLink + "' title='" + e.title + "'><div class='img'> <img src='" + e.url + "' /></div><div class='title'><p>" + wordRegion + "</p></div></a></div>";
				});
...
//			var pageSize=parseInt(setPageSize<dataLength?setPageSize:dataLength);			
		...
		var squareTitleBelow = function () {
			...
			$.each(this.options.dataList, function (i, e) {
				...
				var wordRegion = "";
				picHtml += "<div class='galleryPic " + _this.options.pageSizeClass + "'> <a href='" + e.hyperLink + "' target='_blank' title=" + e.title + "><div class='img'> <img src='" + e.url + "' /></div><div class='title'><p>" + e.title + "</p></div></a> </div>"; //width="+(picWidth-10)+"px;'
		...
		var galleryArtType = function () {
			...
			$.each(this.options.dataList, function (i, e) {
				...
				if (_this.options.isNoSkip) {
					picHtml += "<div class='galleryPic " + pageSizeNum + "'><div class='img'> <img src='" + e.url + "' /></div><div class='title'><p>" + wordRegion + "</p></div></div>"; //width="+(picWidth-10)+"px;'
				} else {
					picHtml += "<div class='galleryPic " + pageSizeNum + "'> <a href='" + e.hyperLink + "' target='_blank' title=" + e.title + "><div class='img'> <img src='" + e.url + "' /></div><div class='title'><p>" + wordRegion + "</p></div></a> </div>"; //width="+(picWidth-10)+"px;'
				}
			});
		...
		var bTitleMaskDes = function () {
			...
			$.each(this.options.dataList, function (i, e) {
				...
				picHtml += "<div class='galleryPic " + _this.options.pageSizeClass + "'> <a href='" + e.hyperLink + "' target='_blank' title=" + e.title + "><div class='img'> <img src='" + e.url + "' /></div><div class='title'>" + e.title + "</div><div class='desc'>" + wordRegion + "</div></a> </div>"; //width="+(picWidth-10)+"px;'
			});
			this.$container.find(" .lar-galleryWrapper .inner").addClass(_this.options.galleryMode).append(picHtml);
			$(this.$container).find(".title").css(_this.options.setTitleStyle);
			/*hover效果*/
		...
		var bwordRegionArtType = function () {
			...
			$.each(this.options.dataList, function (i, e) {
				...
				picHtml += "<div class='galleryPic " + _this.options.pageSizeClass + "'> <a href='" + e.hyperLink + "' target='_blank' title=" + e.title + "><div class='img'> <img src='" + e.url + "'/></div><div class='wordRegion'><p><span class='title'>" + e.title + "</span><br/><span class='desc'>" + wordRegion + "<span></p></div></a><div class='artType'>" + e.artType + "</div> </div>"; //width="+(picWidth-10)+"px;'
			});
			this.$container.find(" .lar-galleryWrapper .inner").addClass(_this.options.galleryMode).append(picHtml);
		...
		var twoRowsGallery = function () {
			...
			for (var i = 0; i < dataListLength; i++) {
				if (i % 2 == 1) {
					picHtml += '<div class="imgArea"><a target= _blank href="' + this.options.dataList[i].hyperLink + '" title="' + this.options.dataList[i].title + '"><img src="' + this.options.dataList[i].url + '" /><span class="title">' + this.options.dataList[i].title + '</span></a></div>';
		...
		var wordRegionRight = function () {
			...
			$.each(this.options.dataList, function (i, e) {
				...
				var wordRegion = e.des;
				picHtml += "<div class='galleryPic pageSizeOne'> <a href='" + e.hyperLink + "' target='_blank' title=" + e.title + "><div class='img'> <img src='" + e.url + "' /></div><div class='wordRegion'><p><span class='title'>" + e.title + "</span><span class='bottomBorder'></span><br/><span class='desc'>" + wordRegion + "</span><div class='gotoDetail'><span class='tip'>进入详情</span><span class='gotoIcon'></span></div></p></div></a></div>"; //width="+(picWidth-10)+"px;'
			});
			this.$container.find(" .lar-galleryWrapper .inner").addClass(_this.options.galleryMode).append(picHtml);
