 ...
 *
 */
window.$=i.a,function(e){function t(t,n){this.options=e.extend(!0,{},this.defaults,n),this.ThumbGallery=t,this.$ThumbGallery=e(t),this.$arrow=e(t).next(),this.$galleryPics,this.thumbPadding=3,this.thumbHeight=100,this.thumbGalleryHeight=500,this.getTotalPicNo=function(){return e(".thumbGallerySideBar img").length},this.galleryType=this.options.galleryType,this.init()}t.prototype={constructor:t,defaults:{dataInfo:[],galleryType:"horizon",paramMap:{imgPath:"imgPath"}},init:function(){this.buildDom(this.options.dataInfo),this.autoShowPic(),this._bindShowPicEvent()},buildDom:function(t){var n=this;this.$ThumbGallery.addClass(this.options.galleryType);var r=e('<div class="thumbGalleryMainArea"></div>'),i=e('<div class="thumbGallerySideBar"></div>');if(r.append('<a target="_blank" href="'+n.options.paramMap.link+"?id="+t[0][n.options.paramMap.id]+'"><img src="'+URL_FILE_SERVER+t[0][n.options.paramMap.imgPath]+'"/></a>'),n.options.paramMap.title){var o=e('<div class="carousel-caption"></div>');r.find("a").append(o),o.text(t[0][n.options.paramMap.title]||""),""===o.text()?o.hide():o.show()}e.each(t,function(e,r){n.options.paramMap.title?i.append('<img name="'+t[e][n.options.paramMap.id]+'" data-title="'+(t[e][n.options.paramMap.title]||"")+'" src="'+URL_FILE_SERVER+t[e][n.options.paramMap.imgPath]+'"/>'):i.append('<img name="'+t[e][n.options.paramMap.id]+'" src="'+URL_FILE_SERVER+t[e][n.options.paramMap.imgPath]+'"/>')}),t.length>0&&i.find("img").eq(0).addClass("selected current"),e(".thumbGalleryContainer").append(r),e(".thumbGalleryContainer").append(i),e(".thumbGallerySideBar").perfectScrollbar()},autoShowPic:function(){var e=this;e.options.dataInfo.length>1&&(e.Timer=setTimeout(function(){e._goNextPic()},5e3))},_bindShowPicEvent:function(){var t=this;e(".thumbGallerySideBar img").bind("click",function(){t._showPic(e(this))})},_scrollTo:function(t){var n=this.thumbHeight+2*this.thumbPadding;e(".thumbGallerySideBar").animate({scrollTop:n*t},1e3)},_showPic:function(t){var n=this;e(".thumbGalleryMainArea a").attr("href",n.options.paramMap.link+"?id="+t.attr("name")),n.options.paramMap.title&&(e(".thumbGalleryMainArea a .carousel-caption").text(t.attr("data-title")),e(".thumbGalleryMainArea a .carousel-caption").attr("title",t.attr("data-title")),""===e(".thumbGalleryMainArea a .carousel-caption").text()?e(".thumbGalleryMainArea a .carousel-caption").hide():e(".thumbGalleryMainArea a .carousel-caption").show()),e(".thumbGalleryMainArea img").hide().attr("src",t.attr("src")).fadeIn(500),e(".thumbGallerySideBar img").removeClass("selected").addClass("current"),t.addClass("selected").addClass("current"),n._scrollTo(t.index()),n.Timer&&(clearTimeout(n.Timer),n.autoShowPic())},_getCurrentPic:function(){return e(".thumbGallerySideBar").find("img.selected")},_getFisrtPic:function(){return e(".thumbGallerySideBar").find("img").eq(0)},_goNextPic:function(){var e=this;e._isLastImg(e._getCurrentPic())?e._showPic(e._getFisrtPic()):e._showPic(e._getCurrentPic().next())},_isLastImg:function(e){return e.index()==this.getTotalPicNo()-1}},e.fn.thumbGallery=function(n){return this.each(function(){return e.data(this,"ThumbGallery",new t(this,n))})}}(jQuery)}});