 ...
 */
window.$=i.a,function(e){function t(t,n){this.options=e.extend(!0,{},this.defaults,n),this.GalleryWall=t,this.$GalleryWall=e(t),this.$arrow=e(t).next(),this.pageNumber=this.options.pageNumber,this.$galleryPics,this.picHeight,this.picWidth,this.afterLoad=this.options.afterLoad,this.executed=!1,this.init()}t.prototype={constructor:t,defaults:{dataUrl:"data.json",galleryType:"tall",titleType:"mask",pageSize:"8",pageNumber:1,showTitle:!0,defaultPicType:"",selfAdaption:!1,paramMap:{imgPath:"imgPath",title:"title",id:"id"},link:""},init:function(){this.buildDom(),this.loadingImg(),this.bindArrowEvent()},buildDom:function(){this.$GalleryWall.empty(),this.$GalleryWall.next("div").remove(),this.$GalleryWall.after('<div style="margin-bottom: 30px; margin-top: 0px;" class="btn_dropDown"><button class="icon btn_arrow"></button></div>')},loadingImg:function(){var t=this,n=e.extend(t.options.param,{pageSize:t.options.pageSize,curPage:t.pageNumber++});t.initImageSize(),e.post(this.options.dataUrl,n,function(r){2==t.pageNumber&&(t.buildDom(),t.bindArrowEvent()),r.model.allDataCount/t.options.pageSize<=n.curPage&&t.$GalleryWall.next(".btn_dropDown").hide();var i="";e.each(r.model.curPageData,function(e,n){i+='<div class="gWImgContainer">'+t.setPicLink(t.options.paramMap.linkType,n,t.options.paramMap.id),t.options.selfAdaption?i+='<div style="width: 95%; height: 95%; margin:0 auto; overflow: hidden;"><img style="margin-left:0px; margin-right:0px; width: 100%; height: 100%; " title="'+n[t.options.paramMap.title]+'" class="'+t.pageNumber+"^"+e+'" src="'+URL_FILE_SERVER+n[t.options.paramMap.imgPath]+'" onerror="placeholderImg(\''+t.options.defaultPicType+"',this);\"></div>":i+='<img style="width: '+t.picWidth+"px; height: "+t.picHeight+'px;" title="'+n[t.options.paramMap.title]+'" class="'+t.pageNumber+"^"+e+'" src="'+URL_FILE_SERVER+n[t.options.paramMap.imgPath]+'" onerror="placeholderImg(\''+t.options.defaultPicType+"',this);\">",i+=t.setPicLinkAfter(t.options.paramMap.linkType,n,t.options.paramMap.id)+"</div>"});var o=e(i);t.$GalleryWall.append(o),t.renderTitle(o,r.model.curPageData),!1===t.executed&&"function"==typeof t.afterLoad&&(t.afterLoad.apply(this,[r]),t.executed=!0)},"json")},bindArrowEvent:function(){var e=this;e.$arrow=e.$GalleryWall.next(),e.$arrow.unbind("click").bind("click",function(){e.loadingImg()})},renderTitle:function(e,t){"mask"==this.options.titleType?this.renderMaskTitle(e,t):"default"==this.options.titleType&&this.renderDefaultTitle(e,t)},renderMaskTitle:function(t,n){var r=this;t.each(function(t,i){e(this).find("a").append("<p class='gwTitle gwMaskTitle'>"+n[t][r.options.paramMap.title]+"</p>"),e(this).hover(function(){e('<a href="'+e(this).find("a").attr("href")+' " target="'+e(this).find("a").attr("target")+'"><div class="picMask"><h4>'+n[t][r.options.paramMap.title]+"</h4><p>"+n[t][r.options.paramMap.audioAuthor]+"</p></div></a>").hide().appendTo(e(this)).fadeIn(500)},function(){e(this).find(".picMask").remove()})})},renderDefaultTitle:function(t,n){var r=this;t.each(function(t,i){e(this).children("a,div").append("<p class='gwTitle' title='"+n[t][r.options.paramMap.title]+"'>"+n[t][r.options.paramMap.title]+"</p>")})},initImageSize:function(){var e=this;"square"==e.options.galleryType?(e.picWidth=220,e.picHeight=220):"tall"==e.options.galleryType&&(e.picWidth=180,e.picHeight=220)},setPicLink:function(e,t,n){var r=this;if(this.options.link)return'<a target="_blank" href="'+r.options.link+"?id="+t[n]+'">';var i=t[e];return t[n]&&t[e]?'<a target="_blank" href="'+r.options.paramMap.linkMap[i]+"?id="+t[n]+'">':"<div>"},setPicLinkAfter:function(e,t,n){return this.options.link?"</a>":t[n]&&t[e]?"</a>":"</div>"},setPicSrc:function(e){return DEFAULT_IMAGE}},e.fn.galleryWall=function(n){return this.each(function(){return e.data(this,"galleryWall",new t(this,n))})}}(jQuery)}});